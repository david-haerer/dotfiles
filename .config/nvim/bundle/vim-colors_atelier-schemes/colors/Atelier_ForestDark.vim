...
call <sid>hi("MatchParen",    s:gui03, s:gui00, s:cterm00, s:cterm03,  "", "")
...
hi TermCursorNC ctermfg=247    ctermbg=67     guifg=s:gui05 guibg=s:gui0C guisp=NONE cterm=NONE gui=NONE
